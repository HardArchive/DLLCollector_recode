...
void MainWindow::on_treeWidget_DependencyTree_customContextMenuRequested(const QPoint &pos)
{
    ...
    if(item && item->parent()) {
        QAction *act1 = new QAction(trUtf8("Добавить в исключения"), this);
        QAction *act2 = new QAction(trUtf8("Убрать из исключений"), this);
        QAction *act3 = new QAction(trUtf8("Редактор исключений"), this);
        
        actions << act1 << act2 << act3;
        
    } else {
        QAction *act1 = new QAction(trUtf8("Редактор исключений"), this);
